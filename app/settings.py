    ...
    with ui.card().classes('w-full max-w-5xl mx-auto rounded-2xl shadow-lg'):
        ...
        with ui.column().classes('w-full gap-4 px-4 py-4'):
            with ui.card().classes('w-full'):
                ...
                ui.label('（注：根据小红书官方私信规则，陌生人只能1条私信，除非对方回复消息，否则"卡片+文本"模式只能送达卡片）').classes('text-sm text-red-500 font-medium mt-1')
            ...
            with ui.card().classes('w-full'):
                ...
                with ui.row().classes('w-full items-center gap-4 mt-2'):
                    create_text_input('CHECK_USER_ID', '健康检查UserId',
                                      '用于测试账号健康状态的小红书账号的UserID。此号务必需要正常稳定的账号。',
